...
<body>
    ...
    <header>
        <div class="container">
            <div class="logo">
                <img src="images/Logo1_no_text - Copy.png" alt="Code Snippet Logo">
                <h1>Code Snippet</h1>
            </div>
            <nav>
                <ul>
            ...
            <article>
                <div class="text-container">
                    ...
                    <section id="learning-approaches" class="section-container">
                        ...
                        <img src="images/Student-working-on-coding-problem.jpg" alt="Student working on coding problem" style="float: right; margin-left: 15px; margin-bottom: 15px; max-width: 300px; width: 100%;">
                    ...
                    <section id="code-organization" class="section-container">
                        ...
                        <img src="images/Well structured code.jpg" alt="Well-organized code structure" style="float: left; margin-right: 15px; margin-bottom: 15px; max-width: 300px; width: 100%;">
        ...
        <section id="gallery">
            ...
            <div class="gallery-container">
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/JavaScript front-end code Part 1.png" alt="JavaScript front-end code part 1" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/JavaScript front-end code Part 2.png" alt="JavaScript front-end code part 2" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/JavaScript front-end code Part 3.png" alt="JavaScript front-end code part 3" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/Java object-oriented design Part1.png" alt="Java object-oriented design" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/Java object-oriented design Part2.png" alt="Java object-oriented design" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/C Application Frameworks.png" alt="C# application framework" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/SQL Database Queries Part 1.png" alt="SQL database queries" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/SQL Database Queries Part 2.png" alt="SQL database queries" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/HTML structure Part 1.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/HTML structure Part 2.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/HTML structure Part 3.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/CSS component structure Part 1.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/CSS component structure Part 2.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/CSS component structure Part 3.png" alt="HTML structure" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
                ...
                <div class="snippet-group">
                    ...
                    <div class="image-row">
                        <img src="images/PHP component structure Part 1.png" alt="PHP component structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/PHP component structure Part 2.png" alt="PHP component structure" class="snippet-image" onclick="openLightbox(this)">
                        <img src="images/PHP component structure Part 3.png" alt="PHP component structure" class="snippet-image" onclick="openLightbox(this)">
                    </div>
                </div>
            </div>
        </section>
    ...
    <footer>
        <div class="container">
            <div style="display: flex; flex-wrap: wrap; justify-content: space-between; margin-bottom: 1rem;">
                <div>
                    <div class="logo">
                        <img src="images/Logo1_no_text - Copy.png" alt="Code Snippet Logo" style="float: left;">
                        <h3>Code Snippet</h3>
                    </div>
